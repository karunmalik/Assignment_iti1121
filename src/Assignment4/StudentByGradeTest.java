...
/**
 * 
 * Class StudentByGrade is a class to test class StudentByGrade
 * It tests a sequence of insertions of different kinds to assert the correctess
 * of all situations encountered by the two new methods "add" (which in turn depends
 * on a correct implementation of new method "find" for BinarySearchTree)
 * 
 * @author Lucia Moura
 *
 */
